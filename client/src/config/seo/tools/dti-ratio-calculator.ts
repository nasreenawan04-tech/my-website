...
export const dtiRatioCalculatorSEO: ToolSEOConfig = {
  slug: 'dti-ratio-calculator',
  category: 'finance',
  title: 'DTI Ratio Calculator - Calculate financial metrics Instantly | DapsiWow',
  ...
  howTo: {
    name: 'How to Use the DTI Ratio Calculator',
  ...
  content: {
    introduction: 'Calculate your debt-to-income ratio for loan qualification and financial health assessment. Our free dti ratio calculator provides instant, accurate results with no registration required.',
