...
export const waistToHeightRatioCalculatorSEO: ToolSEOConfig = {
  ...
  keywords: [
    ...
    "waist-to-height ratio calculator online",
  ...
  content: {
    introduction: 'Calculate waist-to-height ratio. Our free waist-to-height ratio calculator provides instant, accurate results with no registration required.',
