...
export const simpleInterestCalculatorSEO: ToolSEOConfig = {
  ...
  category: 'finance',
  title: 'Simple Interest Calculator - Calculate interest Instantly | DapsiWow',
  ...
  content: {
    introduction: 'Calculate simple interest on principal amount. Our free simple interest calculator provides instant, accurate results with no registration required.',
