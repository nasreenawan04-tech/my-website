...
export const carLoanCalculatorSEO: ToolSEOConfig = {
  ...
  category: 'finance',
  title: 'Car Loan Calculator - Calculate monthly payments Instantly | DapsiWow',
  ...
  howTo: {
    name: 'How to Use the Car Loan Calculator',
  ...
  content: {
    introduction: 'Calculate car loan payments and interest. Our free car loan calculator provides instant, accurate results with no registration required.',
