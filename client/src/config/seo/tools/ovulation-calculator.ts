...
export const ovulationCalculatorSEO: ToolSEOConfig = {
  ...
  content: {
    introduction: 'Track fertile days and ovulation date for conception planning. Our free ovulation calculator provides instant, accurate results with no registration required.',
