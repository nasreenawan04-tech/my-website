...
export const smokingCostCalculatorSEO: ToolSEOConfig = {
  ...
  keywords: [
    ...
    "smoking cost calculator online",
  ...
  schema: {
    ...
    alternateName: [
      "Smoking Cost Calculator",
      "Online Smoking Cost Calculator",
      "Free Smoking Cost Calculator"
],
  ...
  content: {
    introduction: 'Calculate the cost of smoking habits. Our free smoking cost calculator provides instant, accurate results with no registration required.',
