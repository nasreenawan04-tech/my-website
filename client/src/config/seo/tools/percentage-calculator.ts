...
export const percentageCalculatorSEO: ToolSEOConfig = {
  slug: 'percentage-calculator',
  category: 'finance',
  title: 'Percentage Calculator - Calculate financial metrics Instantly | DapsiWow',
  ...
  content: {
    introduction: 'Calculate percentages and percentage changes. Our free percentage calculator provides instant, accurate results with no registration required.',
