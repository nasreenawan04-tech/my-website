...
export const lifeExpectancyCalculatorSEO: ToolSEOConfig = {
  ...
  keywords: [
    ...
    "life expectancy calculator online",
  ...
  content: {
    introduction: 'Estimate life expectancy based on lifestyle. Our free life expectancy calculator provides instant, accurate results with no registration required.',
