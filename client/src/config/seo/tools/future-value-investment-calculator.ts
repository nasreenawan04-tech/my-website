...
export const futureValueInvestmentCalculatorSEO: ToolSEOConfig = {
  slug: 'future-value-investment-calculator',
  category: 'finance',
  title: 'Future Value Investment Calculator - Calculate financial metrics Instantly | DapsiWow',
  ...
  keywords: [
    ...
    "future value investment calculator online",
  ...
  schema: {
    ...
    alternateName: [
      "Future Value Investment Calculator",
      "Online Future Value Investment Calculator",
      "Free Future Value Investment Calculator"
],
  ...
  howTo: {
    name: 'How to Use the Future Value Investment Calculator',
  ...
  content: {
    introduction: 'Project investment growth over time with compound interest. Our free future value investment calculator provides instant, accurate results with no registration required.',
