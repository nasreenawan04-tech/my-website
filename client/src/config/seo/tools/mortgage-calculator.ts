...
export const mortgageCalculatorSEO: ToolSEOConfig = {
  ...
  category: 'finance',
  title: 'Mortgage Calculator - Calculate monthly payments Instantly | DapsiWow',
  ...
  content: {
    introduction: 'Calculate mortgage payments and compare rates. Our free mortgage calculator provides instant, accurate results with no registration required.',
