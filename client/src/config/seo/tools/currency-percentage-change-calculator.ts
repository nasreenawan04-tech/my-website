...
export const currencyPercentageChangeCalculatorSEO: ToolSEOConfig = {
  slug: 'currency-percentage-change-calculator',
  category: 'finance',
  title: 'Currency Percentage Change Calculator - Calculate financial metrics Instantly | DapsiWow',
  ...
  keywords: [
    ...
    "currency percentage change calculator online",
  ...
  schema: {
    ...
    alternateName: [
      "Currency Percentage Change Calculator",
      "Online Currency Percentage Change Calculator",
      "Free Currency Percentage Change Calculator"
],
  ...
  howTo: {
    name: 'How to Use the Currency Percentage Change Calculator',
  ...
  content: {
    introduction: 'Calculate how much a value increased or decreased in percentage. Our free currency percentage change calculator provides instant, accurate results with no registration required.',
