...
export const businessLoanCalculatorSEO: ToolSEOConfig = {
  ...
  category: 'finance',
  title: 'Business Loan Calculator - Calculate monthly payments Instantly | DapsiWow',
  ...
  content: {
    introduction: 'Calculate business loan payments and metrics. Our free business loan calculator provides instant, accurate results with no registration required.',
