...
export const dailyStepCalorieConverterSEO: ToolSEOConfig = {
  ...
  keywords: [
    ...
    "daily steps to calories converter online",
  ...
  schema: {
    ...
    alternateName: [
      "Daily Steps to Calories Converter",
      "Online Daily Steps to Calories Converter",
      "Free Daily Steps to Calories Converter"
],
  ...
  content: {
    introduction: 'Convert steps walked to calories burned with personal factors. Our free daily steps to calories converter provides instant, accurate results with no registration required.',
