...
export const inflationCalculatorSEO: ToolSEOConfig = {
  slug: 'inflation-calculator',
  category: 'finance',
  title: 'Inflation Calculator - Calculate financial metrics Instantly | DapsiWow',
  ...
  howTo: {
    name: 'How to Use the Inflation Calculator',
  ...
  content: {
    introduction: 'Calculate inflation impact over time. Our free inflation calculator provides instant, accurate results with no registration required.',
