...
export const bodyWaterPercentageCalculatorSEO: ToolSEOConfig = {
  ...
  keywords: [
    ...
    "body water percentage calculator online",
  ...
  schema: {
    ...
    alternateName: [
      "Body Water Percentage Calculator",
      "Online Body Water Percentage Calculator",
      "Free Body Water Percentage Calculator"
],
  ...
  howTo: {
    name: 'How to Calculate water intake',
    description: 'Get your water intake results in 3 easy steps using our scientifically-validated calculator.',
    totalTime: 'PT2M',
    steps: [
      {
        position: 1,
  ...
  faq: [
    ...
    {
        "question": "How often should I recalculate my water intake?",
  ...
  content: {
    introduction: 'Calculate your total body water percentage and get personalized hydration recommendations. Our free body water percentage calculator provides instant, accurate results with no registration required.',
