...
export const idealWeightCalculatorSEO: ToolSEOConfig = {
  ...
  content: {
    introduction: 'Calculate ideal body weight using multiple proven formulas. Our free ideal weight calculator provides instant, accurate results with no registration required.',
