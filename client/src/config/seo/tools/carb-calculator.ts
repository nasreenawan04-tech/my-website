...
export const carbCalculatorSEO: ToolSEOConfig = {
  ...
  content: {
    introduction: 'Calculate daily carbohydrate needs. Our free carb calculator provides instant, accurate results with no registration required.',
