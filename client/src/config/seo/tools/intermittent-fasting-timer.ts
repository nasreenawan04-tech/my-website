...
export const intermittentFastingTimerSEO: ToolSEOConfig = {
  ...
  schema: {
    ...
    alternateName: [
      "Intermittent Fasting Timer",
      "Online Intermittent Fasting Timer",
      "Free Intermittent Fasting Timer"
],
  ...
  content: {
    introduction: 'Track intermittent fasting periods and eating windows. Our free intermittent fasting timer provides instant, accurate results with no registration required.',
