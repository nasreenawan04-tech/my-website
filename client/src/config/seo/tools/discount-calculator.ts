...
export const discountCalculatorSEO: ToolSEOConfig = {
  slug: 'discount-calculator',
  category: 'finance',
  title: 'Discount Calculator - Calculate financial metrics Instantly | DapsiWow',
  ...
  content: {
    introduction: 'Calculate discounts and final prices. Our free discount calculator provides instant, accurate results with no registration required.',
