...
export const loanComparisonCalculatorSEO: ToolSEOConfig = {
  slug: 'loan-comparison-calculator',
  category: 'finance',
  title: 'Loan Comparison Calculator - Calculate monthly payments Instantly | DapsiWow',
  ...
  schema: {
    ...
    alternateName: [
      "Loan Comparison Calculator",
      "Online Loan Comparison Calculator",
      "Free Loan Comparison Calculator"
],
  ...
  howTo: {
    name: 'How to Use the Loan Comparison Calculator',
  ...
  content: {
    introduction: 'Compare different loan offers side-by-side with EMI, interest rates, and total cost analysis. Our free loan comparison calculator provides instant, accurate results with no registration required.',
