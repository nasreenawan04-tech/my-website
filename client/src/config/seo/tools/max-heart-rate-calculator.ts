...
export const maxHeartRateCalculatorSEO: ToolSEOConfig = {
  ...
  keywords: [
    ...
    "max heart rate calculator online",
  ...
  schema: {
    ...
    alternateName: [
      "Max Heart Rate Calculator",
      "Online Max Heart Rate Calculator",
      "Free Max Heart Rate Calculator"
],
  ...
  content: {
    introduction: 'Calculate maximum heart rate using multiple scientific formulas. Our free max heart rate calculator provides instant, accurate results with no registration required.',
