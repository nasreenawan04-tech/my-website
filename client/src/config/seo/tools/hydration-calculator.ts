...
export const hydrationCalculatorSEO: ToolSEOConfig = {
  ...
  content: {
    introduction: 'Calculate your optimal daily water intake based on weight, activity level, climate, and health factors for proper hydration. Our free hydration calculator provides instant, accurate results with no registration required.',
