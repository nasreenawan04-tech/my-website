...
export const paypalFeeCalculatorSEO: ToolSEOConfig = {
  slug: 'paypal-fee-calculator',
  category: 'finance',
  title: 'PayPal Fee Calculator - Calculate financial metrics Instantly | DapsiWow',
  ...
  howTo: {
    name: 'How to Use the PayPal Fee Calculator',
  ...
  content: {
    introduction: 'Calculate PayPal transaction fees. Our free paypal fee calculator provides instant, accurate results with no registration required.',
