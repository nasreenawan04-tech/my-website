...
export const babyGrowthChartSEO: ToolSEOConfig = {
  ...
  content: {
    introduction: 'Track baby growth and development using WHO standards. Our free baby growth chart provides instant, accurate results with no registration required.',
