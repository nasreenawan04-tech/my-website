...
export const heartRateCalculatorSEO: ToolSEOConfig = {
  ...
  content: {
    introduction: 'Calculate target heart rate zones for optimal training and fitness. Our free heart rate calculator provides instant, accurate results with no registration required.',
