...
export const debtPayoffCalculatorSEO: ToolSEOConfig = {
  slug: 'debt-payoff-calculator',
  category: 'finance',
  title: 'Debt Payoff Calculator - Calculate debt payoff time Instantly | DapsiWow',
  ...
  content: {
    introduction: 'Calculate time to pay off debts. Our free debt payoff calculator provides instant, accurate results with no registration required.',
