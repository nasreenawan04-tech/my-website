...
export const runningPaceCalculatorSEO: ToolSEOConfig = {
  ...
  keywords: [
    ...
    "running pace calculator online",
  ...
  content: {
    introduction: 'Calculate running pace and times. Our free running pace calculator provides instant, accurate results with no registration required.',
