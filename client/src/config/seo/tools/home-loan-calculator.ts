...
export const homeLoanCalculatorSEO: ToolSEOConfig = {
  ...
  category: 'finance',
  title: 'Home Loan Calculator - Calculate monthly payments Instantly | DapsiWow',
  ...
  content: {
    introduction: 'Calculate home loan EMI and interest. Our free home loan calculator provides instant, accurate results with no registration required.',
