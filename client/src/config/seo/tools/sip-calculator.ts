...
export const sipCalculatorSEO: ToolSEOConfig = {
  slug: 'sip-calculator',
  category: 'finance',
  title: 'SIP Calculator - Calculate financial metrics Instantly | DapsiWow',
  ...
  content: {
    introduction: 'Calculate Systematic Investment Plan returns. Our free sip calculator provides instant, accurate results with no registration required.',
