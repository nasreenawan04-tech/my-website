...
export const pregnancyDueDateCalculatorSEO: ToolSEOConfig = {
  ...
  content: {
    introduction: 'Calculate expected delivery date and pregnancy milestones. Our free pregnancy due date calculator provides instant, accurate results with no registration required.',
