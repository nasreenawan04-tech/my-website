...
export const tdeeCalculatorSEO: ToolSEOConfig = {
  ...
  howTo: {
    ...
    description: 'Get your TDEE results in 3 easy steps using our scientifically-validated calculator.',
    totalTime: 'PT2M',
    steps: [
      {
        position: 1,
  ...
  content: {
    introduction: 'Calculate Total Daily Energy Expenditure. Our free tdee calculator provides instant, accurate results with no registration required.',
