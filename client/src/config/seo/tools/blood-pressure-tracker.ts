...
export const bloodPressureTrackerSEO: ToolSEOConfig = {
  ...
  content: {
    introduction: 'Track and monitor blood pressure readings with instant classification. Our free blood pressure tracker provides instant, accurate results with no registration required.',
