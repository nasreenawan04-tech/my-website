...
export const sleepQualityCalculatorSEO: ToolSEOConfig = {
  ...
  keywords: [
    ...
    "sleep quality calculator online",
  ...
  schema: {
    ...
    alternateName: [
      "Sleep Quality Calculator",
      "Online Sleep Quality Calculator",
      "Free Sleep Quality Calculator"
],
  ...
  content: {
    introduction: 'Assess your sleep quality and get personalized recommendations for better rest. Our free sleep quality calculator provides instant, accurate results with no registration required.',
