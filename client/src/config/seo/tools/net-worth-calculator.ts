...
export const netWorthCalculatorSEO: ToolSEOConfig = {
  slug: 'net-worth-calculator',
  category: 'finance',
  title: 'Net Worth Calculator - Calculate financial metrics Instantly | DapsiWow',
  ...
  content: {
    introduction: 'Calculate your total net worth. Our free net worth calculator provides instant, accurate results with no registration required.',
