...
export const emiCalculatorSEO: ToolSEOConfig = {
  slug: 'emi-calculator',
  category: 'finance',
  title: 'EMI Calculator - Calculate financial metrics Instantly | DapsiWow',
  ...
  content: {
    introduction: 'Calculate Equated Monthly Installments for loans. Our free emi calculator provides instant, accurate results with no registration required.',
