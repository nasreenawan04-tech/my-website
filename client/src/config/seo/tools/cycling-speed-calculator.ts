...
export const cyclingSpeedCalculatorSEO: ToolSEOConfig = {
  ...
  keywords: [
    ...
    "cycling speed calculator online",
  ...
  schema: {
    ...
    alternateName: [
      "Cycling Speed Calculator",
      "Online Cycling Speed Calculator",
      "Free Cycling Speed Calculator"
],
  ...
  content: {
    introduction: 'Calculate cycling speed and distance. Our free cycling speed calculator provides instant, accurate results with no registration required.',
