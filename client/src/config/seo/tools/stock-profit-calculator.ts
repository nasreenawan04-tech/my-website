...
export const stockProfitCalculatorSEO: ToolSEOConfig = {
  slug: 'stock-profit-calculator',
  category: 'finance',
  title: 'Stock Profit Calculator - Calculate financial metrics Instantly | DapsiWow',
  ...
  howTo: {
    name: 'How to Use the Stock Profit Calculator',
  ...
  content: {
    introduction: 'Calculate profit/loss on stock investments. Our free stock profit calculator provides instant, accurate results with no registration required.',
