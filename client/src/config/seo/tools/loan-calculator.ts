...
export const loanCalculatorSEO: ToolSEOConfig = {
  ...
  category: 'finance',
  title: 'Loan Calculator - Calculate monthly payments Instantly | DapsiWow',
  ...
  content: {
    introduction: 'Calculate monthly payments and total interest for any loan. Our free loan calculator provides instant, accurate results with no registration required.',
