...
export const debtConsolidationCalculatorSEO: ToolSEOConfig = {
  slug: 'debt-consolidation-calculator',
  category: 'finance',
  title: 'Debt Consolidation Calculator - Calculate debt payoff time Instantly | DapsiWow',
  metaDescription: 'Calculate debt payoff time instantly with our free calculator. Get instant results, detailed insights, and professional-grade accuracy. No registration required. Try now!',
  keywords: [
  ...
  howTo: {
    ...
    description: 'Calculate debt payoff time in just 3 simple steps using our free online tool.',
    totalTime: 'PT2M',
    steps: [
      {
        position: 1,
  ...
  faq: [
    ...
    },
    {
        ...
        "answer": "Absolutely! Our calculator is fully responsive and works seamlessly on smartphones, tablets, and desktop computers. Calculate debt payoff time anywhere, anytime."
    },
    {
  ...
  content: {
    introduction: 'Calculate potential savings from consolidating multiple debts into a single loan. Our free debt consolidation calculator provides instant, accurate results with no registration required.',
