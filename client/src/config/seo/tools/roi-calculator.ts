...
export const roiCalculatorSEO: ToolSEOConfig = {
  slug: 'roi-calculator',
  category: 'finance',
  title: 'ROI Calculator - Calculate return on investment Instantly | DapsiWow',
  ...
  content: {
    introduction: 'Calculate return on investment percentage. Our free roi calculator provides instant, accurate results with no registration required.',
