...
export const bmrCalculatorSEO: ToolSEOConfig = {
  ...
  howTo: {
    ...
    description: 'Get your BMR results in 3 easy steps using our scientifically-validated calculator.',
    totalTime: 'PT2M',
    steps: [
      {
        position: 1,
  ...
  content: {
    introduction: 'Calculate Basal Metabolic Rate and daily calorie needs. Our free bmr calculator provides instant, accurate results with no registration required.',
