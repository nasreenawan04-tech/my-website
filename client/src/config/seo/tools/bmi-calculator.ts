...
export const bmiCalculatorSEO: ToolSEOConfig = {
  ...
  howTo: {
    ...
    description: 'Get your BMI results in 3 easy steps using our scientifically-validated calculator.',
    totalTime: 'PT2M',
    steps: [
      {
        position: 1,
  ...
  content: {
    introduction: 'Calculate your Body Mass Index and get health insights. Our free bmi calculator provides instant, accurate results with no registration required.',
