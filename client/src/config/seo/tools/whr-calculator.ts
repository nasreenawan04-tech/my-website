...
export const whrCalculatorSEO: ToolSEOConfig = {
  ...
  keywords: [
    ...
    "whr calculator (waist-hip ratio) online",
  ...
  schema: {
    ...
    alternateName: [
      "WHR Calculator (Waist-Hip Ratio)",
      "Online WHR Calculator (Waist-Hip Ratio)",
      "Free WHR Calculator (Waist-Hip Ratio)"
],
  ...
  content: {
    introduction: 'Calculate waist-to-hip ratio. Our free whr calculator (waist-hip ratio) provides instant, accurate results with no registration required.',
