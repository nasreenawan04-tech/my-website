...
export const waterIntakeCalculatorSEO: ToolSEOConfig = {
  ...
  keywords: [
    ...
    "water intake calculator online",
  ...
  content: {
    introduction: 'Calculate daily water requirements. Our free water intake calculator provides instant, accurate results with no registration required.',
