...
export const cholesterolRiskCalculatorSEO: ToolSEOConfig = {
  ...
  keywords: [
    ...
    "cholesterol risk calculator online",
  ...
  schema: {
    ...
    alternateName: [
      "Cholesterol Risk Calculator",
      "Online Cholesterol Risk Calculator",
      "Free Cholesterol Risk Calculator"
],
  ...
  content: {
    introduction: 'Assess cholesterol-related health risks. Our free cholesterol risk calculator provides instant, accurate results with no registration required.',
