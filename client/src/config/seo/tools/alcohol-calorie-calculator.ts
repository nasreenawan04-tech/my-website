...
export const alcoholCalorieCalculatorSEO: ToolSEOConfig = {
  ...
  keywords: [
    ...
    "alcohol calorie calculator online",
  ...
  schema: {
    ...
    alternateName: [
      "Alcohol Calorie Calculator",
      "Online Alcohol Calorie Calculator",
      "Free Alcohol Calorie Calculator"
],
  ...
  content: {
    introduction: 'Calculate calories in alcoholic drinks. Our free alcohol calorie calculator provides instant, accurate results with no registration required.',
