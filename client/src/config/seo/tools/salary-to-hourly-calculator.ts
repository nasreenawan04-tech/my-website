...
export const salaryToHourlyCalculatorSEO: ToolSEOConfig = {
  slug: 'salary-to-hourly-calculator',
  category: 'finance',
  title: 'Salary to Hourly Calculator - Calculate financial metrics Instantly | DapsiWow',
  ...
  keywords: [
    ...
    "salary to hourly calculator online",
  ...
  schema: {
    ...
    alternateName: [
      "Salary to Hourly Calculator",
      "Online Salary to Hourly Calculator",
      "Free Salary to Hourly Calculator"
],
  ...
  howTo: {
    name: 'How to Use the Salary to Hourly Calculator',
  ...
  content: {
    introduction: 'Convert annual salary to hourly wage. Our free salary to hourly calculator provides instant, accurate results with no registration required.',
