...
export const mealCalorieTrackerSEO: ToolSEOConfig = {
  ...
  content: {
    introduction: 'Track your daily calorie intake by adding meals with detailed nutritional information and progress monitoring. Our free meal calorie tracker provides instant, accurate results with no registration required.',
