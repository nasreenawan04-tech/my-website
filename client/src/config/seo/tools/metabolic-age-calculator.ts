...
export const metabolicAgeCalculatorSEO: ToolSEOConfig = {
  ...
  schema: {
    ...
    alternateName: [
      "Metabolic Age Calculator",
      "Online Metabolic Age Calculator",
      "Free Metabolic Age Calculator"
],
  ...
  content: {
    introduction: 'Calculate your metabolic age based on lifestyle factors and health metrics with personalized longevity recommendations. Our free metabolic age calculator provides instant, accurate results with no registration required.',
