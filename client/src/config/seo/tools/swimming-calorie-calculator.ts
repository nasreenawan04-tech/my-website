...
export const swimmingCalorieCalculatorSEO: ToolSEOConfig = {
  ...
  keywords: [
    ...
    "swimming calorie calculator online",
  ...
  schema: {
    ...
    alternateName: [
      "Swimming Calorie Calculator",
      "Online Swimming Calorie Calculator",
      "Free Swimming Calorie Calculator"
],
  ...
  content: {
    introduction: 'Calculate calories burned while swimming. Our free swimming calorie calculator provides instant, accurate results with no registration required.',
