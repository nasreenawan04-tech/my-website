...
export const personalFinanceDashboardSEO: ToolSEOConfig = {
  slug: 'personal-finance-dashboard',
  category: 'finance',
  title: 'Personal Finance Dashboard - Calculate financial metrics Instantly | DapsiWow',
  ...
  keywords: [
    ...
    "personal finance dashboard online",
  ...
  howTo: {
    name: 'How to Use the Personal Finance Dashboard',
  ...
  content: {
    introduction: 'Comprehensive financial overview with income, expenses, savings, and investment tracking. Our free personal finance dashboard provides instant, accurate results with no registration required.',
