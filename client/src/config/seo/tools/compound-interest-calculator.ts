...
export const compoundInterestCalculatorSEO: ToolSEOConfig = {
  ...
  category: 'finance',
  title: 'Compound Interest Calculator - Calculate interest Instantly | DapsiWow',
  ...
  content: {
    introduction: 'Calculate compound interest on investments. Our free compound interest calculator provides instant, accurate results with no registration required.',
