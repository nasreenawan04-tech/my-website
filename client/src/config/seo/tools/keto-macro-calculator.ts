...
export const ketoMacroCalculatorSEO: ToolSEOConfig = {
  ...
  content: {
    introduction: 'Calculate macros for ketogenic diet. Our free keto macro calculator provides instant, accurate results with no registration required.',
