...
export const vatGstCalculatorSEO: ToolSEOConfig = {
  slug: 'vat-gst-calculator',
  category: 'finance',
  title: 'VAT/GST Calculator - Calculate financial metrics Instantly | DapsiWow',
  ...
  howTo: {
    name: 'How to Use the VAT/GST Calculator',
  ...
  content: {
    introduction: 'Calculate VAT and GST on products. Our free vat/gst calculator provides instant, accurate results with no registration required.',
