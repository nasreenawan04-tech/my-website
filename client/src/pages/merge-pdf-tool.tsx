            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mt-12 space-y-8">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">How to Merge PDF Files</h2>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center">
                      <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <Upload className="w-8 h-8 text-blue-600" />
                      </div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-2">1. Upload Files</h3>
                      <p className="text-gray-600">
                        Drag and drop your PDF files or click to select them from your computer.
                      </p>
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 mb-2">2. Reorder Files</h3>
                      <p className="text-gray-600">
                        Use the up/down arrows to arrange your PDFs in the desired order.
                      </p>
                    </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900">Free & Unlimited</h3>
                        <p className="text-gray-600 text-sm">Merge as many PDF files as you want, completely free.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Files are processed locally in your browser for privacy.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900">Easy Reordering</h3>
                        <p className="text-gray-600 text-sm">Drag and drop or use arrows to arrange PDF order.</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div className="bg-blue-50 rounded-lg p-4">
                      <h3 className="font-semibold text-gray-900 mb-2">📑 Document Assembly</h3>
                      <p className="text-sm text-gray-600">Combine separate chapters into a complete document.</p>
                    </div>
                    
                    <div className="bg-green-50 rounded-lg p-4">
                      <h3 className="font-semibold text-gray-900 mb-2">📋 Report Creation</h3>
                      <p className="text-sm text-gray-600">Merge multiple reports into a single comprehensive file.</p>
                    </div>
                    
                    <div className="bg-purple-50 rounded-lg p-4">
                      <h3 className="font-semibold text-gray-900 mb-2">📄 Contract Bundling</h3>
                      <p className="text-sm text-gray-600">Combine contracts, terms, and attachments into one PDF.</p>
                    </div>
                    
                    <div className="bg-orange-50 rounded-lg p-4">
                      <h3 className="font-semibold text-gray-900 mb-2">🎓 Academic Papers</h3>
                      <p className="text-sm text-gray-600">Merge research papers, citations, and appendices.</p>
                    </div>
                    
                    <div className="bg-red-50 rounded-lg p-4">
                      <h3 className="font-semibold text-gray-900 mb-2">📊 Presentation Slides</h3>
                      <p className="text-sm text-gray-600">Combine multiple presentation files into one.</p>
                    </div>
                    
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h3 className="font-semibold text-gray-900 mb-2">📱 Digital Organization</h3>
                      <p className="text-sm text-gray-600">Organize scattered PDFs into organized bundles.</p>
                    </div>
                  </div>
                </div>
              </div>
