                  ...
                  {analysis ? (
                    <div className="space-y-4 sm:space-y-6 md:space-y-8" data-testid="analysis-results">
                      ...
                      {analysis.feedback.length > 0 && (
                        <div className="space-y-2 sm:space-y-3">
                          <h3 className="font-bold text-gray-900 text-sm sm:text-base">Improvement Suggestions</h3>
                    ...
                    <div className="text-center py-12 sm:py-16 md:py-20" data-testid="no-results">
                      ...
                      <p className="text-gray-500 text-base sm:text-lg px-4">Enter a password to analyze its strength</p>
                    </div>
                  )}
                </div>
              </div>
