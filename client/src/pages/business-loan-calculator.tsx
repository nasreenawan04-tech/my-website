...
export default function BusinessLoanCalculator() {
  ...
  const shareOnTwitter = () => {
    ...
    const tweetText = `💼 Business Loan Calculator Results: ${formatCurrency(result.monthlyPayment)}/month on ${formatCurrency(parseFloat(loanAmount))} at ${interestRate}% - Calculate yours free!`;
