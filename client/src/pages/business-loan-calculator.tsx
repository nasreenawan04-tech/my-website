    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <main>
        ...
        <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-12 lg:py-16">
          ...
          <Card className="bg-gradient-to-br from-purple-50 via-pink-50 to-red-50 border-0 shadow-xl rounded-lg sm:rounded-xl md:rounded-2xl overflow-hidden mt-4 sm:mt-6 md:mt-8">
            <CardContent className="p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                ...
                <div className="bg-white p-4 sm:p-5 md:p-6 lg:p-8 rounded-lg sm:rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-colors duration-300">
                  ...
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs sm:text-sm text-gray-500 truncate">Restaurant Owner</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white p-4 sm:p-5 md:p-6 lg:p-8 rounded-lg sm:rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-colors duration-300">
                  ...
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="font-bold text-gray-900 text-xs sm:text-sm md:text-base truncate">Jennifer Martinez</p>
                      <p className="text-xs sm:text-sm text-gray-500 truncate">Manufacturing Business Owner</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white p-4 sm:p-5 md:p-6 lg:p-8 rounded-lg sm:rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-colors duration-300">
                  ...
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="font-bold text-gray-900 text-xs sm:text-sm md:text-base truncate">David Thompson</p>
                      <p className="text-xs sm:text-sm text-gray-500 truncate">Tech Startup Founder</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 sm:mt-8 md:mt-10 text-center">
                <div className="inline-flex flex-col xs:flex-row items-center gap-1.5 xs:gap-2 bg-white px-4 sm:px-5 md:px-6 py-2.5 sm:py-3 rounded-full shadow-md">
                  ...
                  <span className="text-gray-600 text-xs sm:text-sm md:text-base">from 2,847+ reviews</span>
                </div>
              </div>
            </CardContent>
          </Card>
