...
import { binaryToTextConverterSEO } from '@/config/seo/tools/binary-to-text-converter';
            ...
            <CardContent className="p-0">
              <div className="flex flex-col">
                ...
                <div className="p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 2xl:p-14 space-y-4 sm:space-y-6 md:space-y-8">
                  <div>
                    <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-4xl 2xl:text-4xl font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4">Binary Decoder</h2>
                    <p className="text-sm sm:text-base md:text-lg lg:text-lg xl:text-xl text-gray-600">Enter binary code, decimal values, or hexadecimal to decode text</p>
                  </div>
                  ...
                  <div className="space-y-4 sm:space-y-5 md:space-y-6">
                    ...
                    {/* Code Input */}
                    <div className="space-y-2 sm:space-y-3">
                      <Label htmlFor="code-input" className="text-xs sm:text-sm md:text-base font-semibold text-gray-800 uppercase tracking-wide">
                        {getInputFormatLabel()}
                      </Label>
                      <Textarea
                        id="code-input"
                ...
                <div className="bg-gradient-to-br from-gray-50 to-blue-50 p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 2xl:p-14 border-t">
                  ...
                  {conversionResult && conversionResult.originalInput ? (
                      ...
                      <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-3 sm:p-4 md:p-5 lg:p-6">
                        <div className="flex items-center justify-between mb-3 sm:mb-4 gap-3">
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs sm:text-sm md:text-base text-gray-600 break-words">Human-readable text output</p>
                          </div>
                          <Button
                    ...
                    <div className="text-center py-8 sm:py-12 md:py-16 lg:py-20" data-testid="no-results">
                      ...
                      <p className="text-gray-500 text-sm sm:text-base md:text-lg lg:text-xl px-4">Enter binary, decimal, or hex code to decode text</p>
                    </div>
                  )}
                </div>
              </div>
