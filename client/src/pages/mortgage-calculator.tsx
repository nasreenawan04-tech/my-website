                ...
                {result ? (
                  <div ref={resultsRef} className="bg-gradient-to-br from-gray-50 to-blue-50 p-3 sm:p-4 md:p-6 lg:p-8 xl:p-10 2xl:p-12 border-t">
                    ...
                    <div className="space-y-4 sm:space-y-6 md:space-y-8">
                      ...
                      {showAmortization && (
                        <div ref={amortizationRef} className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-sm border border-gray-100 border-t-4 border-t-blue-200">
                      ...
                      {showComparison && comparisonMortgages.length > 0 && (
                        <div ref={comparisonRef} className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-sm border border-gray-100 border-t-4 border-t-blue-200">
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
