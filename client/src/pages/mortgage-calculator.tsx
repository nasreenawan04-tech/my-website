              ...
              <div className="flex flex-col">
                ...
                {result ? (
                  <div ref={resultsRef} className="bg-gradient-to-br from-gray-50 to-blue-50 p-3 sm:p-4 md:p-6 lg:p-8 xl:p-10 2xl:p-12 border-t">
                    <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-6 sm:mb-8 text-left">Your Mortgage Results</h2>

                    <div className="space-y-4 sm:space-y-6">
                      {/* Main Monthly Payment Card */}
                      <div className="bg-white rounded-xl p-6 sm:p-8 border border-gray-200 shadow-sm">
                        <div className="text-center space-y-3">
                          <div className="text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">Estimated Monthly Payment</div>
                          <div className="text-4xl sm:text-5xl md:text-6xl font-bold text-blue-600 break-all">
                      ...
                      <div className="bg-white rounded-xl p-6 sm:p-8 border border-gray-200 shadow-sm space-y-4">
                        <div className="flex justify-between items-center pb-4 border-b border-gray-100">
                          <span className="text-sm sm:text-base font-medium text-gray-700">Principal & Interest</span>
                          <span className="text-sm sm:text-base font-semibold text-gray-900">{formatCurrency(result.monthlyPrincipalAndInterest)}</span>
                        </div>
                        
                        <div className="flex justify-between items-center pb-4 border-b border-gray-100">
                          <span className="text-sm sm:text-base font-medium text-gray-700">Property Taxes</span>
                          <span className="text-sm sm:text-base font-semibold text-gray-900">{formatCurrency(result.monthlyTaxes)}</span>
                        </div>
                        
                        <div className="flex justify-between items-center pb-4 border-b border-gray-100">
                          <span className="text-sm sm:text-base font-medium text-gray-700">Home Insurance</span>
                          <span className="text-sm sm:text-base font-semibold text-gray-900">{formatCurrency(result.monthlyInsurance)}</span>
                        </div>
                        
                        {result.monthlyPMI > 0 && (
                          <div className="flex justify-between items-center pb-4 border-b border-gray-100">
                            <span className="text-sm sm:text-base font-medium text-gray-700">PMI</span>
                            <span className="text-sm sm:text-base font-semibold text-gray-900">{formatCurrency(result.monthlyPMI)}</span>
                          </div>
                        )}
                        
                        {result.monthlyHOA > 0 && (
                          <div className="flex justify-between items-center pb-4 border-b border-gray-100">
                            <span className="text-sm sm:text-base font-medium text-gray-700">HOA Fees</span>
                            <span className="text-sm sm:text-base font-semibold text-gray-900">{formatCurrency(result.monthlyHOA)}</span>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="bg-white rounded-xl p-6 sm:p-8 border border-gray-200 shadow-sm space-y-4">
                        <div className="flex justify-between items-center pb-4 border-b border-gray-100">
                          <span className="text-sm sm:text-base font-medium text-gray-700">Loan Amount</span>
                        ...
                        <div className="flex justify-between items-center pb-4 border-b border-gray-100">
                          <span className="text-sm sm:text-base font-medium text-gray-700">Total Interest Paid</span>
                          <span className="text-sm sm:text-base font-semibold text-orange-600">{formatCurrency(result.totalInterest)}</span>
                        </div>
                        
                        <div className="flex justify-between items-center">
                          <span className="text-sm sm:text-base font-medium text-gray-700">Total Amount Paid</span>
                          <span className="text-sm sm:text-base font-bold text-gray-900">{formatCurrency(result.totalAmount)}</span>
                        </div>
                      </div>
