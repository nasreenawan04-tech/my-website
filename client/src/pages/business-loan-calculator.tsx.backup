              ...
              <div className="flex flex-col lg:grid lg:grid-cols-3 gap-0">
                ...
                <div className="lg:col-span-2 p-3 sm:p-4 md:p-6 lg:p-8 xl:p-10 2xl:p-12 space-y-4 sm:space-y-6 md:space-y-8">
                    ...
                    <div className="space-y-2 sm:space-y-3">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="h-10 sm:h-12 md:h-14 pl-6 sm:pl-8 text-sm sm:text-base md:text-lg border-2 border-gray-200 rounded-lg sm:rounded-xl focus:border-blue-500 focus:ring-blue-500"
                          placeholder="250,000"
                    ...
                    <div className="space-y-2 sm:space-y-3">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          className="h-10 sm:h-12 md:h-14 pr-6 sm:pr-8 text-sm sm:text-base md:text-lg border-2 border-gray-200 rounded-lg sm:rounded-xl focus:border-blue-500 focus:ring-blue-500"
                          placeholder="7.50"
                          step="0.01"
                  ...
                  <div className="space-y-4 sm:space-y-6 border-t pt-4 sm:pt-6 md:pt-8">
                    <h3 className="text-lg sm:text-xl font-bold text-gray-900">Business Information (Optional)</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
                      <div className="space-y-2 sm:space-y-3">
                        ...
                        <p className="text-xs sm:text-sm text-gray-500">Used to calculate debt service coverage ratio</p>
                      </div>
                      ...
                      <div className="space-y-2 sm:space-y-3">
                        ...
                        <p className="text-xs sm:text-sm text-gray-500">Used to calculate loan-to-value ratio</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-gradient-to-br from-gray-50 to-blue-50 p-3 sm:p-4 md:p-6 lg:p-8 xl:p-10 2xl:p-12">
                  <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 md:mb-8">Loan Analysis</h2>
                  
                  {result ? (
                    <div className="space-y-4 sm:space-y-6" data-testid="business-loan-results">
                      ...
                      <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border border-blue-100">
                        ...
                        <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600" data-testid="text-monthly-payment">
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 shadow-sm">
                          <div className="flex justify-between items-center">
                            <span className="text-sm sm:text-base font-medium text-gray-700">Annual Payment</span>
                            <span className="text-sm sm:text-base font-bold text-gray-900" data-testid="text-yearly-payment">
                      ...
                      {(result.debtServiceCoverage > 0 || result.loanToValue > 0) && (
                        <div className="space-y-3 sm:space-y-4">
                          <h4 className="text-base sm:text-lg font-bold text-gray-900">Business Metrics</h4>
                          
                          {result.debtServiceCoverage > 0 && (
                            <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg sm:rounded-xl p-4 sm:p-6 border border-blue-200">
                              <div className="flex justify-between items-center mb-1 sm:mb-2">
                                <span className="text-sm sm:text-base font-medium text-blue-700">Debt Service Coverage Ratio</span>
                                <span className={`text-sm sm:text-base md:text-lg font-bold ${result.debtServiceCoverage >= 1.25 ? 'text-green-600' : result.debtServiceCoverage >= 1.0 ? 'text-yellow-600' : 'text-red-600'}`} data-testid="text-debt-service-coverage">
                          ...
                          {result.loanToValue > 0 && (
                            <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg sm:rounded-xl p-4 sm:p-6 border border-purple-200">
                              <div className="flex justify-between items-center mb-1 sm:mb-2">
                                <span className="text-sm sm:text-base font-medium text-purple-700">Loan-to-Value Ratio</span>
                                <span className={`text-sm sm:text-base md:text-lg font-bold ${result.loanToValue <= 80 ? 'text-green-600' : result.loanToValue <= 90 ? 'text-yellow-600' : 'text-red-600'}`} data-testid="text-loan-to-value">
                      ...
                      <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 shadow-sm border border-gray-200">
                        <div className="flex justify-between items-center">
                          <span className="text-sm sm:text-base font-medium text-gray-700">Loan Type</span>
                    ...
                    <div className="text-center py-8 sm:py-12 md:py-16" data-testid="no-results">
                      ...
                      <p className="text-sm sm:text-base md:text-lg text-gray-500">Enter business loan details to see payment analysis</p>
                    </div>
                  )}
                </div>
              </div>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-lg">
                        ...
                        <th className="px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 text-right text-xs sm:text-sm md:text-base font-bold text-gray-900">Payment</th>
          ...
          <div className="mt-8 sm:mt-12 md:mt-16 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
            <Card className="bg-white/90 backdrop-blur-sm shadow-xl border-0 rounded-xl sm:rounded-2xl">
              <CardContent className="p-4 sm:p-6 md:p-8">
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">What is a Business Loan Calculator?</h3>
            ...
            <Card className="bg-white/90 backdrop-blur-sm shadow-xl border-0 rounded-xl sm:rounded-2xl">
              <CardContent className="p-4 sm:p-6 md:p-8">
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">How Business Loan Calculations Work</h3>
                <div className="space-y-3 sm:space-y-4 text-sm sm:text-base text-gray-600">
                  <p>
            ...
            <Card className="bg-white/90 backdrop-blur-sm shadow-xl border-0 rounded-xl sm:rounded-2xl">
              <CardContent className="p-4 sm:p-6 md:p-8">
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Types of Business Loans</h3>
            ...
            <Card className="bg-white/90 backdrop-blur-sm shadow-xl border-0 rounded-xl sm:rounded-2xl">
              <CardContent className="p-4 sm:p-6 md:p-8">
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Key Financial Metrics</h3>
                <div className="space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-600">
                  <div className="flex items-start gap-3">
