  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Access 15+ free health calculators including BMI, calorie, body fat, and fitness tools. Track your wellness journey with instant, accurate results." />
        ...
        <meta property="og:description" content="Access 15+ free health calculators including BMI, calorie, and fitness tools. Track your wellness with instant results." />
        ...
        <meta name="twitter:description" content="Access 15+ free health calculators for BMI, calories, fitness and more. Instant results, no registration required." />
            ...
            "@graph": [
              {
                ...
                "description": "Access 15+ free health calculators including BMI, calorie, body fat, and fitness tools. Track your wellness journey with instant, accurate results.",
                "inLanguage": "en-US",
                "isPartOf": {
              ...
              },
              {
                ...
                "description": "Comprehensive collection of 15+ free health and fitness calculators",
                "url": "https://dapsiwow.com/health-tools",
                "numberOfItems": 30,
                "itemListElement": [
                  {
        ...
        <main className="flex-1 bg-neutral-50">
          ...
          <section className="bg-gradient-to-r from-pink-600 via-rose-500 to-red-700 text-white py-16 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
              ...
              >
                15+ free health and fitness tools to track, calculate, and improve your wellbeing
              </motion.p>
