  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Access 27+ free health calculators including BMI, calorie, pregnancy, and fitness tools. Track your wellness with instant results." />
        ...
        <meta name="twitter:description" content="Access 27+ free health calculators for BMI, calories, pregnancy and more. Instant results, no registration required." />
          ...
          {JSON.stringify({
            ...
            "@graph": [
              ...
              },
              {
                ...
                "description": "Comprehensive collection of 27+ free health and fitness calculators",
                "url": "https://dapsiwow.com/health-tools",
                "numberOfItems": 30,
                "itemListElement": [
                  {
