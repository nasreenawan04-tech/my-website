      ...
      <main>
            ...
            <div className="space-y-4 sm:space-y-6 md:space-y-8">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold text-slate-900 leading-tight tracking-tight px-2 sm:px-0" data-testid="page-title">
                ...
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 mt-1 sm:mt-2">
                  Calculate Using I = P × R × T Formula
                </span>
              </h1>
        ...
        <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-12 lg:py-16">
          ...
          <div className="mt-12 sm:mt-16 space-y-8 sm:space-y-12">
            ...
            <Card className="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 border-0 shadow-xl rounded-xl sm:rounded-2xl overflow-hidden">
              <CardContent className="p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12">
                <div className="text-center mb-6 sm:mb-8 md:mb-10 lg:mb-12">
                  <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4 leading-tight px-2 sm:px-0">
                    Related Financial Calculators
                  </h2>
                  <p className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed px-3 sm:px-2 md:px-0">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                  ...
                  <a href="/tools/compound-interest-calculator" className="group bg-white p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl md:rounded-2xl hover:shadow-2xl transition-colors duration-300 border-2 border-transparent hover:border-purple-200">
                    ...
                    <div className="flex items-center text-purple-600 text-xs sm:text-sm font-medium mt-auto">
                  ...
                  <a href="/tools/emi-calculator" className="group bg-white p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl md:rounded-2xl hover:shadow-2xl transition-colors duration-300 border-2 border-transparent hover:border-green-200">
                    ...
                    <div className="flex items-center text-green-600 text-xs sm:text-sm font-medium mt-auto">
                  ...
                  <a href="/tools/mortgage-calculator" className="group bg-white p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl md:rounded-2xl hover:shadow-2xl transition-colors duration-300 border-2 border-transparent hover:border-orange-200">
                    ...
                    <div className="flex items-center text-orange-600 text-xs sm:text-sm font-medium mt-auto">
                  ...
                  <a href="/tools/investment-return-calculator" className="group bg-white p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl md:rounded-2xl hover:shadow-2xl transition-colors duration-300 border-2 border-transparent hover:border-red-200">
                    ...
                    <div className="flex items-center text-red-600 text-xs sm:text-sm font-medium mt-auto">
                  ...
                  <a href="/tools/future-value-investment-calculator" className="group bg-white p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl md:rounded-2xl hover:shadow-2xl transition-colors duration-300 border-2 border-transparent hover:border-cyan-200">
                    ...
                    <div className="flex items-center text-cyan-600 text-xs sm:text-sm font-medium mt-auto">
