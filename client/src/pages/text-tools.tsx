  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Access 21+ free text processing tools including word counter, grammar checker, and text analyzers. Transform and optimize content instantly." />
        ...
        <meta property="og:description" content="Access 21+ free text tools including word counter, grammar checker, and more. Process content instantly, no registration." />
        ...
        <meta name="twitter:description" content="Access 21+ free text tools for word counting, grammar checking and more. Instant processing, no registration." />
            ...
            "@graph": [
              {
                ...
                "description": "Access 21+ free text processing tools including word counter, grammar checker, and text analyzers. Transform and optimize content instantly.",
                "inLanguage": "en-US",
                "isPartOf": {
              ...
              },
              {
                ...
                "description": "Comprehensive collection of 21+ free text processing and writing utilities",
                "url": "https://dapsiwow.com/text-tools",
                "numberOfItems": 21,
                "itemListElement": [
                  {
        ...
        <main className="flex-1 bg-neutral-50">
          ...
          <section className="bg-gradient-to-r from-yellow-600 via-orange-500 to-red-600 text-white py-16 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
              ...
              >
                21+ free text and writing tools to analyze, improve, and transform your content
              </motion.p>
