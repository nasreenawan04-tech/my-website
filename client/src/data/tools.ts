...
const toolsData: Tool[] = [
  ...
  },
  {
    ...
    description: "Count paragraphs in documents",
    category: "text" as const,
  ...
  },
  {
    ...
    description: "Convert decimal character codes to readable text",
    category: "text" as const,
    icon: "fas fa-arrow-left",
    href: "/tools/decimal-to-text-converter",
  },
  {
    ...
    href: "/tools/text-to-decimal-converter",
  },
  {
    ...
    category: "text" as const,
    icon: "fas fa-code",
    href: "/tools/hex-to-text-converter",
  },
  {
    id: "text-to-hex-converter",
    name: "Text to Hex Converter",
    description: "Convert text to hexadecimal values",
    category: "text" as const,
    icon: "fas fa-hashtag",
    href: "/tools/text-to-hex-converter",
  },
  {
    id: "font-style-changer",
    name: "Font Style Changer",
    description: "Transform text with stylish fonts",
    category: "text" as const,
    icon: "fas fa-font",
    href: "/tools/font-style-changer",
  },
  {
    id: "markdown-to-html",
  ...
  },
  {
    ...
    description:
      "Calculate optimal sleep and wake times based on natural sleep cycles",
    category: "health" as const,
    icon: "fas fa-bed",
