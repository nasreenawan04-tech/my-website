...
const toolsData = [
  ...
  { id: 'steps-to-calories-Converter', name: 'Daily Step to Calorie Converter', description: 'Convert steps walked to calories burned with personal factors', category: 'health' as const, icon: 'fas fa-walking', href: '/tools/daily-step-calorie-converter' },
