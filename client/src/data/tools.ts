...
const toolsData = [
  ...
  { id: 'daily-steps-to-calories-Converter', name: 'Daily Steps to Calories Converter', description: 'Convert steps walked to calories burned with personal factors', category: 'health' as const, icon: 'fas fa-walking', href: '/tools/daily-steps-to-calories-converter' },
