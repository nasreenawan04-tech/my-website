...
const toolsData: Tool[] = [
  ...
  { id: 'text-similarity-checker', name: 'Text Similarity Checker', description: 'Compare two texts using advanced algorithms to detect similarity, overlap, and potential plagiarism with detailed analysis', category: 'text' as const, icon: 'fas fa-balance-scale', href: '/tools/text-similarity-checker', isPopular: true },
  ...
  { id: 'hydration-calculator', name: 'Hydration Calculator', description: 'Calculate your optimal daily water intake based on weight, activity level, climate, and health factors for proper hydration', category: 'health' as const, icon: 'fas fa-water', href: '/tools/hydration-calculator' },
