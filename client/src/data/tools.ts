...
const toolsData = [
  ...
  { id: 'car-lease-calculator', name: 'Car Lease Calculator', description: 'Calculate monthly car lease payments', category: 'finance' as const, icon: 'fas fa-car', href: '/tools/car-lease-calculator' },
  ...
  { id: 'daily-steps-to-calories-Converter', name: 'Daily Step to Calorie Converter', description: 'Convert steps walked to calories burned with personal factors', category: 'health' as const, icon: 'fas fa-walking', href: '/tools/daily-step-calorie-converter' },
