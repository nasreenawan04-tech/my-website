...
const toolsData = [
  ...
  { id: 'intermittent-fasting', name: 'Intermittent Fasting Timer', description: 'Track intermittent fasting periods and eating windows', category: 'health' as const, icon: 'fas fa-clock', href: '/tools/intermittent-fasting-timer' },
  { id: 'steps-to-calories', name: 'Daily Step to Calorie Converter', description: 'Convert steps walked to calories burned with personal factors', category: 'health' as const, icon: 'fas fa-walking', href: '/tools/daily-step-calorie-converter' },
