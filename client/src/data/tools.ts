...
const toolsData = [
  ...
  { id: 'car-lease-calculator', name: 'Car Lease Calculator', description: 'Calculate monthly car lease payments', category: 'finance' as const, icon: 'fas fa-car', href: '/tools/lease-calculator' },
  ...
  { id: 'currency-converter', name: 'Currency Converter', description: 'Convert between different currencies with live rates', category: 'finance' as const, icon: 'fas fa-exchange-alt', isPopular: true },
  { id: 'roi-calculator', name: 'ROI Calculator', description: 'Calculate return on investment percentage', category: 'finance' as const, icon: 'fas fa-trending-up' },
  ...
  // PDF Tools (30)
  { id: 'pdf-editor', name: 'PDF Editor', description: 'Edit PDF files online with our advanced editor', category: 'pdf' as const, icon: 'fas fa-file-pdf', isPopular: true },
  ...
  { id: 'split-pdf', name: 'Split PDF', description: 'Split PDF into multiple documents', category: 'pdf' as const, icon: 'fas fa-cut' },
  ...
  { id: 'protect-pdf', name: 'Protect PDF with Password', description: 'Add password protection to PDF files', category: 'pdf' as const, icon: 'fas fa-lock' },
  { id: 'watermark-pdf', name: 'Add Watermark to PDF', description: 'Add text or image watermarks to PDF', category: 'pdf' as const, icon: 'fas fa-tint' },
  ...
  { id: 'pdf-page-numbers', name: 'PDF Page Number Adder', description: 'Add page numbers to PDF documents', category: 'pdf' as const, icon: 'fas fa-list-ol' },
  { id: 'organize-pdf', name: 'Organize PDF Pages', description: 'Reorder and organize PDF pages', category: 'pdf' as const, icon: 'fas fa-sort' },
  { id: 'extract-pdf-pages', name: 'Extract Pages from PDF', description: 'Extract specific pages from PDF', category: 'pdf' as const, icon: 'fas fa-file-export' },
  ...
  { id: 'character-counter', name: 'Character Counter', description: 'Count characters in text with/without spaces', category: 'text' as const, icon: 'fas fa-font' },
  { id: 'sentence-counter', name: 'Sentence Counter', description: 'Count sentences in your text', category: 'text' as const, icon: 'fas fa-list' },
  ...
  { id: 'blog-title-generator', name: 'Blog Title Generator', description: 'Generate catchy blog titles', category: 'text' as const, icon: 'fas fa-heading' },
  { id: 'meta-description-generator', name: 'Meta Description Generator', description: 'Create SEO meta descriptions', category: 'text' as const, icon: 'fas fa-tags' },
  ...
  { id: 'fake-name', name: 'Fake Name Generator', description: 'Generate fake names for testing', category: 'text' as const, icon: 'fas fa-id-card' },
  ...
  { id: 'pregnancy-due-date', name: 'Pregnancy Due Date Calculator', description: 'Calculate expected delivery date and pregnancy milestones', category: 'health' as const, icon: 'fas fa-baby', href: '/tools/pregnancy-due-date-calculator' },
  { id: 'ideal-weight', name: 'Ideal Weight Calculator', description: 'Calculate ideal body weight using multiple proven formulas', category: 'health' as const, icon: 'fas fa-balance-scale', href: '/tools/ideal-weight-calculator' },
  ...
  { id: 'protein-intake', name: 'Protein Intake Calculator', description: 'Calculate daily protein requirements', category: 'health' as const, icon: 'fas fa-drumstick-bite' },
  { id: 'carb-calculator', name: 'Carb Calculator', description: 'Calculate daily carbohydrate needs', category: 'health' as const, icon: 'fas fa-bread-slice' },
  { id: 'keto-macro', name: 'Keto Macro Calculator', description: 'Calculate macros for ketogenic diet', category: 'health' as const, icon: 'fas fa-calculator' },
  { id: 'intermittent-fasting', name: 'Intermittent Fasting Timer', description: 'Track intermittent fasting periods', category: 'health' as const, icon: 'fas fa-clock' },
  { id: 'steps-to-calories', name: 'Daily Step to Calorie Converter', description: 'Convert steps walked to calories burned', category: 'health' as const, icon: 'fas fa-walking' },
  { id: 'heart-rate-calculator', name: 'Heart Rate Calculator', description: 'Calculate target heart rate zones', category: 'health' as const, icon: 'fas fa-heartbeat' },
  { id: 'max-heart-rate', name: 'Max Heart Rate Calculator', description: 'Calculate maximum heart rate by age', category: 'health' as const, icon: 'fas fa-heart' },
  { id: 'blood-pressure-tracker', name: 'Blood Pressure Tracker', description: 'Track and monitor blood pressure', category: 'health' as const, icon: 'fas fa-stethoscope' },
  { id: 'sleep-calculator', name: 'Sleep Calculator', description: 'Calculate optimal sleep and wake times', category: 'health' as const, icon: 'fas fa-bed' },
  ...
  { id: 'lean-body-mass', name: 'Lean Body Mass Calculator', description: 'Calculate lean body mass', category: 'health' as const, icon: 'fas fa-user-md' },
