  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="home loan calculator, home loan EMI, mortgage EMI calculator, housing loan calculator, property loan calculator" />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-purple-50 rounded-lg p-6">
                      ...
                      <p className="text-gray-600 text-sm">
                        ...
                        Make informed decisions about real estate investment opportunities.
                      </p>
                    </div>
